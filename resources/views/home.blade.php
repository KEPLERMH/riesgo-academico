...
@section('content')
    <div style="padding: 20px">
        ...
        <div class="form-row col-12" style="display: flex;flex-wrap: wrap;margin-top: 30px">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #DCECC0 ;border-radius: 2px;">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #C091E2;border-radius: 2px;">
                <div style="display: flex;justify-content: space-between;align-items: center;padding: 19px">
                    <div style="border-right: solid rgb(192, 145, 226) 2px"><img
                            style="min-width: 100px;max-width: 100px;height: 100px;max-height: 100px"
                            src="{{ asset('img/admin.svg') }}" alt=""></div>
                    <div
                        style="font-size: 30px;color:  rgb(192, 145, 226);font-weight: bold;background: rgba(0, 0, 0, 0.13);padding: 5px">
                        @foreach ($sql as $item)
                            {{ $item->total }}
                        @endforeach
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #FFC300;border-radius: 2px;">
                <div style="display: flex;justify-content: space-between;align-items: center;padding: 19px">
                    <div style="border-right: solid rgb(255, 255, 255) 2px"><img
                            style="min-width: 100px;max-width: 100px;height: 100px;max-height: 100px"
                            src="{{ asset('img/student.svg') }}" alt=""></div>
                    <div
                        style="font-size: 30px;color:  rgb(87, 183, 213);font-weight: bold;background: rgba(0, 0, 0, 0.13);padding: 5px">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #91D0E2;border-radius: 2px;">
                <div style="display: flex;justify-content: space-between;align-items: center;padding: 19px">
                    <div style="border-right: solid rgb(255, 255, 255) 2px"><img
                            style="min-width: 100px;max-width: 100px;height: 100px;max-height: 100px"
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #EEC7A7;border-radius: 2px;">
                <div style="display: flex;justify-content: space-between;align-items: center;padding: 19px">
                    <div style="border-right: solid rgb(255, 255, 255) 2px"><img
                            style="min-width: 100px;max-width: 100px;height: 100px;max-height: 100px"
                ...
                <h4 style="color: white" class="text-center">CARRERA</h4>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background: #1088008a;border-radius: 2px;">
                ...
                <h4 style="color: white" class="text-center">GRADO Y CARRERA</h4>
            </div>
